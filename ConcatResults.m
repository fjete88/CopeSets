...
for k = 1:prod(dimR(1:end-1))
    ...
    for l = 1:dimR(end)
        ...
        if l==1
            ...
            result{k}.covRate.truebdry = result{k}.covRate.truebdry + tmp{k,l}.nsim * tmp{k,l}.covRate.truebdry;
            result{k}.covRate.linbdry  = result{k}.covRate.linbdry  + tmp{k,l}.nsim * tmp{k,l}.covRate.linbdry;
            result{k}.covRate.erodbdry = result{k}.covRate.erodbdry + tmp{k,l}.nsim * tmp{k,l}.covRate.erodbdry;
